    ...
    >
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-8 sm:mb-12 space-y-3 sm:space-y-4">
          <h2 id="partners-titulo" className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#ff7300] [text-shadow:_2px_2px_4px_rgba(0,0,0,0.3)]">
            {titulo}
          </h2>
          {subtitulo && (
